	...
	<div id="header">
		...
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a accesskey="5" title="">我参加的小组</a></li>
			</ul>
		</div>
	</div>
	<div id="main">
		...
		<div id="featured">
			<?php
				...
				$sql2 = mysql_query("SELECT * 
					FROM group_users AS gu, weigroup AS w
					WHERE gu.userid = ".$_SESSION[userid]."
					AND gu.groupid = w.groupid;",$conn);	
			?>
			<div class="title">
				<h3>参与的小组</h3>
			</div>
