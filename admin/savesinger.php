...
mysql_query("insert into singer(singername,sex,area,zuhe,num) values ('$singername','$singersex','$singerarea','$singerzuhe','$singernum');",$conn);
echo "<script language='javascript'>alert('成功添加$singername');history.back();</script>";
?>
