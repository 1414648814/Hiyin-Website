...
$(function() {
	$.fn.manhuaDate = function(options) {
		...
		for(var i=options.beginY; i<=options.endY; i++){
			$("<option value='"+i+"'>"+i+"Year</option>").appendTo($("#year"));
		}
		for(var i=1; i<=12; i++){
			$("<option value='"+i+"'>"+i+"Month</option>").appendTo($("#month"));
		}		
