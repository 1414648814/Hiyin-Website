		...
		<div class="about-grids">
			<div class="selectarea">
				...
				<?php
					...
					else if($_GET[singer_sex]=="women"){
						$_SESSION[singer_sex] = "women";
					}
					$sql=mysql_query("select count(*) as num
						from singer as s, yanchanghui as y,singertoyanchanghui as sty
            			WHERE y.id = sty.yanchanghui_id
            			AND s.id = sty.singer_id  
                        and y.sale='on' and s.sex ='".$_SESSION[singer_sex]."';",$conn);

					$info=mysql_fetch_array($sql);
					$total=$info[num];
					if($total==0)
					{	
						echo $_SESSION[singer_sex]."歌手最近没有任何演唱会!";
					}
					else
					{
			...
			<div class="featured-top">
				<div class="dalu">
					<h3><?php echo $_SESSION[singer_sex];?></h3>
				</div>
				<?php
					$pagesize=10;
					if ($total<=$pagesize){
					...
					$sql1=mysql_query("select s.singername,s.num,s.pic,s.id
            			...
            			WHERE y.id = sty.yanchanghui_id
            			AND s.id = sty.singer_id  
                        and y.sale='on' and s.sex ='".$_SESSION[singer_sex]."' 
				...
				<div class="featured-box">
					...
					?>
						<a href="mingxinginfo.php?singerid=<?php echo $result[id]?>"><img src="<?php echo "$result[pic]";?>" alt=""/>
					<?php
						}
					?>
			...
			<div class="fenye">
				<table>
					...
					<a href="mingxingsex.php?sex=<?php echo $_SESSION[singer_sex];?>" title="首页"><font face="webdings"> 9 </font></a> 
					<a href="mingxingsex.php?sex=<?php echo $_SESSION[singer_sex];?>&page=<?php echo $page-1;?>" title="前一页"><font face="webdings"> 7 </font></a>
					<?php
						}
						if($pagecount<=4){
					...
					<a href="mingxingsex.php?sex=<?php echo $_SESSION[singer_sex];?>&page=<?php echo $i;?>"><?php echo $i;?></a>
					...
					?>
					<a href="mingxingsex.php?sex=<?php echo $_SESSION[singer_sex];?>&page=<?php echo $page-1;?>" title="后一页?><font face="webdings"> 8 </font></a> 
					<a href="mingxingsex.php?sex=<?php echo $_SESSION[singer_sex];?>&page=<?php echo $pagecount;?>" title="尾页"><font face="webdings"> : </font></a>
					<?php 
						}
					?>
